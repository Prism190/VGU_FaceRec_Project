...
Although large face recognition models can achieve high accuracy, they are often too expensive for edge devices or real-time video applications. This has motivated the development of lightweight architectures such as MobileFaceNets and MobileNet-based models. These networks reduce parameter count and computational cost while attempting to preserve recognition accuracy\cite{mobilefacenets}.
