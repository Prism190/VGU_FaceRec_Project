...
\begin{table*}[h]
\centering
\caption{Template pooling ablation on IJB-B/C. TAR at FAR=$10^{-4}$ is the primary metric for access control.}
...
\hline
V1/latest & mean             & 99.38 & 92.91 & 86.61 & 99.55 & 94.40 & 89.13 \\
V1/latest & magface\_weighted & 99.12 & 93.51 & \textbf{87.98} & 99.37 & 94.87 & \textbf{90.65} \\
V1/latest & top5             & — & — & — & — & — & — \\
V1/latest & top10            & — & — & — & — & — & — \\
V3/SWA    & mean             & 99.20 & 92.23 & 85.11 & 99.32 & 93.51 & 87.74 \\
V3/SWA    & magface\_weighted & 99.19 & 92.23 & \textbf{85.27} & 99.30 & 93.54 & \textbf{87.77} \\
V3/SWA    & top5             & — & — & — & — & — & — \\
V3/SWA    & top10            & — & — & — & — & — & — \\
\hline
\end{tabular}
...
Mean pooling produces slightly higher AUC overall but underperforms \texttt{magface\_weighted} at strict FAR ($10^{-4}$), the operating point relevant for access control. \texttt{magface\_weighted} wins by 1.37\% on V1/latest IJB-B and 1.52\% on V1/latest IJB-C at TAR@$10^{-4}$. This validates the design choice: quality-weighting by embedding norm consistently prioritizes higher-quality face observations and achieves better calibration at low FAR. (top5/top10 results pending from the running ablation.)
